...
public class ArrayHelperTest {
    ...
    public void getMostFrequentElementsOfK() {
        ...
        Assert.assertArrayEquals(new Object[]{'0', '1', '2', '5', '6', '9', '8'}, ArrayHelper.getMostFrequentElementsOfK(charsArray, 10));
        //String array test
        Object[] strArray = {"aabb", "test", "test", "test", "test", "bbcc"};
        Assert.assertArrayEquals(new Object[]{"test", "aabb", "bbcc"}, ArrayHelper.getMostFrequentElementsOfK(strArray, 10));
        //Integer array test
